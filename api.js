const imageToGuesses = {
    'jakub.png': ['jakub', 'yzo', 'jakub vlcek', 'yzomandias'],
    'decky beats.png': ['decky beats', 'decky'],
    'dominik.png': ['dominik', 'nik tendo', 'nik', 'dominik citta', 'goldcigo'],
    'karlo.png': ['karlo', 'juraj', 'juraj caba', 'gumbgu'],
    'tomas.png': ['tomas', 'tkeej'],
    'nobodylisten.png': ['nobodylisten', 'nobody listen', 'nobody listens', 'jakub strach', 'nobody'],
    'sara.png': ['sara', 'sara rikas', 'sarinka', '50 rocna zena'],
    'robin zoot.png': ['robin zoot', 'zoot', 'robin'],
    'jickson.png': ['jickson', 'jimmy', 'D', 'dickson'],
    'koky.png': ['koky'],
    'soul.png': ['saul'],
    'samey.png': ['samey', 'samo'],
    'zayo.png': ['zayo', 'matus zajac', 'zajac', 'zay jack'],
    'viktor.png': ['viktor', 'viktor sheen', 'viktor dundic'],
    'PTK.png': ['ptk', 'PTK', 'patrik'],
    'astralkid.png': ['astralkid', 'astral', 'astralkid22'],
    'shimi.png': ['shimmi', 'oliver'],
    'lucabrassi.png': ['lucabrassi', 'lucabrassi10x', 'luca', 'lukas', 'gambler', 'fetak', 'alkoholic'],
    'hasan.png': ['hasan'],
    'separ.png': ['separ'],
    'calin.png': ['calin', 'calin panfili'],
    'stein27.png': ['stein27', 'stein', 'peter']
};
